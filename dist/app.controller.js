...
let AppController = (() => {
    ...
    (() => {
        ...
        _assets_decorators = [(0, assets_decorator_1.Assets)(role_enum_1.Roles.MEDICO), (0, common_1.Get)('/*')];
        __esDecorate(_classThis, null, _assets_decorators, { kind: "method", name: "assets", static: false, private: false, access: { has: obj => "assets" in obj, get: obj => obj.assets }, metadata: _metadata }, null, _instanceExtraInitializers);
