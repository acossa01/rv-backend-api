...
let BlacklistedToken = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('blacklisted_tokens')];
    ...
    var BlacklistedToken = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "BlacklistedToken");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('uuid')];
        _token_decorators = [(0, typeorm_1.Index)({ unique: true }), (0, typeorm_1.Column)({ type: 'text' })];
        ...
        BlacklistedToken = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BlacklistedToken = _classThis;
})();
