...
const usuarios_resolver_1 = require("./usuarios.resolver");
let UsuariosModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            providers: [
                ...
                usuarios_resolver_1.UsuariosResolver,
            ],
    ...
    let _classThis;
    var UsuariosModule = _classThis = class {
    };
    __setFunctionName(_classThis, "UsuariosModule");
    (() => {
